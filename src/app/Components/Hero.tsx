    ...
    <section className="section hero" id="home" aria-label="hero">
      <div className="container mx-auto px-4">
        <div className="hero-content text-center">
          ...
          "Empowering Communities, Sustaining Futures: Your Guide to Responsible E-Waste Disposal" 
            <br /> <motion.span
          ...
          E-Trace: Transforming E-Waste Management. Find E-waste facilities effortlessly with our platform.
          </p>
